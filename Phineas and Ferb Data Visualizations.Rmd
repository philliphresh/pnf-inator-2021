...
songs %>% 
  ...
  annotate(geom = "label", x = lubridate::ymd("2010-01-01"), y = 7.1, 
           size = 3, hjust = 0, lineheight = .8,
           label = "Phineas and Ferb Musical Cliptastic\nCountdown Hosted by Kelly Osbourne") + 
  
  annotate(geom = "label", x = lubridate::ymd("2014-01-01"), y = 9.25, 
           size = 3, hjust = 0, lineheight = .8,
           label = "Act Your Age") +
  
  annotate(geom = "label", x = lubridate::ymd("2014-07-01"), y = 9.1, 
           size = 3, hjust = 0, lineheight = .8,

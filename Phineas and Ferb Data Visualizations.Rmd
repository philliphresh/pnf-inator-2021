...
songs_I_like <- 
  ...
  "Ain't Got Rhythm",
  "Snuck Your Way Right Into My Heart",
  "Little Brother",
  "Chains On Me",
  "Yodel Odel Obey Me",
...
songs %>% 
  arrange(air_date) %>% 
  mutate(songs_I_really_like = if_else(song_names %in% songs_I_like, "I really like it", "It's okay"))
  ggplot(aes(air_date, imdb_rating)) +
  geom_point(aes(color = song_names %in% songs_I_like))
```
